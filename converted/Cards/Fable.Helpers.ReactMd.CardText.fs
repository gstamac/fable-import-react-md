// node_modules/react-md/lib/Cards/CardText.d.ts
...
type CardTextProps =
    ...
    abstract expandable: bool option with get, set
    abstract children: React.ReactNode option with get, set

type ICardTextProp = inherit Fable.Helpers.React.Props.IHTMLProp
type CardTextProp = 
...
module CardText =
    ...
    let inline comp (b: ICardTextProp list) c = Fable.Helpers.React.from CardTextComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from CardTextComp !!(keyValueList CaseRules.LowerFirst b) c
