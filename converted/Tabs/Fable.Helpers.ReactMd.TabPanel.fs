// node_modules/react-md/lib/Tabs/TabPanel.d.ts
...
type TabPanelProps =
    ...
    abstract contolledById: string with get, set
...
type ITabPanelProp = inherit Fable.Helpers.React.Props.IHTMLProp
type TabPanelProp = 
...
module TabPanel =
    ...
    let inline comp (b: ITabPanelProp list) c = Fable.Helpers.React.from TabPanelComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from TabPanelComp !!(keyValueList CaseRules.LowerFirst b) c
