// node_modules/react-md/lib/NavigationDrawers/JumpToContentLink.d.ts
...
type JumpToContentLinkProps =
    inherit Props


type IJumpToContentLinkProp = inherit Fable.Helpers.React.Props.IHTMLProp
type JumpToContentLinkProp = 
...
module JumpToContentLink =
    ...
    let inline comp (b: IJumpToContentLinkProp list) c = Fable.Helpers.React.from JumpToContentLinkComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from JumpToContentLinkComp !!(keyValueList CaseRules.LowerFirst b) c
