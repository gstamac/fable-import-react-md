// node_modules/react-md/lib/NavigationDrawers/CloseButton.d.ts
...
type ICloseButtonProp = inherit Fable.Helpers.React.Props.IHTMLProp
...
module CloseButton =
    ...
    let inline comp (b: ICloseButtonProp list) c = Fable.Helpers.React.from CloseButtonComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from CloseButtonComp !!(keyValueList CaseRules.LowerFirst b) c
