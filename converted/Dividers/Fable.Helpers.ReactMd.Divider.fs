// node_modules/react-md/lib/Dividers/Divider.d.ts
...
type IDividerProp = inherit Fable.Helpers.React.Props.IHTMLProp
type DividerProp = 
...
module Divider =
    ...
    let inline comp (b: IDividerProp list) c = Fable.Helpers.React.from DividerComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from DividerComp !!(keyValueList CaseRules.LowerFirst b) c
