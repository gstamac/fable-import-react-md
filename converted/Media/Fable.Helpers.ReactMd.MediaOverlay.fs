// node_modules/react-md/lib/Media/MediaOverlay.d.ts
...
type IMediaOverlayProp = inherit Fable.Helpers.React.Props.IHTMLProp
type MediaOverlayProp = 
...
module MediaOverlay =
    ...
    let inline comp (b: IMediaOverlayProp list) c = Fable.Helpers.React.from MediaOverlayComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from MediaOverlayComp !!(keyValueList CaseRules.LowerFirst b) c
