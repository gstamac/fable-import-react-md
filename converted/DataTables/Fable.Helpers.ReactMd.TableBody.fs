// node_modules/react-md/lib/DataTables/TableBody.d.ts
...
type ITableBodyProp = inherit Fable.Helpers.React.Props.IHTMLProp
type TableBodyProp = 
...
module TableBody =
    ...
    let inline comp (b: ITableBodyProp list) c = Fable.Helpers.React.from TableBodyComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from TableBodyComp !!(keyValueList CaseRules.LowerFirst b) c
