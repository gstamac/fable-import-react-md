// node_modules/react-md/lib/DataTables/TableHeader.d.ts
...
type ITableHeaderProp = inherit Fable.Helpers.React.Props.IHTMLProp
...
module TableHeader =
    ...
    let inline comp (b: ITableHeaderProp list) c = Fable.Helpers.React.from TableHeaderComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from TableHeaderComp !!(keyValueList CaseRules.LowerFirst b) c
