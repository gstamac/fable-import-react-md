// node_modules/react-md/lib/DataTables/TableFooter.d.ts
...
type ITableFooterProp = inherit Fable.Helpers.React.Props.IHTMLProp
...
module TableFooter =
    ...
    let inline comp (b: ITableFooterProp list) c = Fable.Helpers.React.from TableFooterComp !!(keyValueList CaseRules.LowerFirst b) c
    let inline comp2 (b: Fable.Helpers.React.Props.IHTMLProp list) c = Fable.Helpers.React.from TableFooterComp !!(keyValueList CaseRules.LowerFirst b) c
